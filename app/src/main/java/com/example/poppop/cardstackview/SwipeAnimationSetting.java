...
import com.example.poppop.cardstackview.internal.AnimationSetting;

public class SwipeAnimationSetting implements AnimationSetting {

    private final com.example.poppop.cardstackview.Direction direction;
    private final int duration;
    private final Interpolator interpolator;

    private SwipeAnimationSetting(
            com.example.poppop.cardstackview.Direction direction,
            int duration,
